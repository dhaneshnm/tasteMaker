...
## Amendment — 2026-08-19, story 0023 (the standing order)

The 20% prediction above was made under the manual regime, where every published day
implied a curator choosing it. Story 0023 makes the machine fill the queue and museum
...
auto-picked published days, ~Sep 20, 2026). The `auto_tier` column ships with 0023 and
